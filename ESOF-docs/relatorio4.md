...
Por fim, quanto à heterogeneidade, dada a utilização de poucas tecnologias distintas , o *Atom* não revela problemas assinalaveis que impliquem a utilização de soluções teconológicas muito diversas.
